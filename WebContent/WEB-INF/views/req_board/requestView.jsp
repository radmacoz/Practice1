...
<body>
	...
	<article>
		...
		<div class="reqButton">
			<button>
				<a href="requestReplyForm.do?board_num=${req_board.board_num }&board_ref=${req_board.board_ref}&board_re_step=${req_board.board_re_step}&board_re_level=${req_board.board_re_level}">답변</a>
			</button>
			<button>
